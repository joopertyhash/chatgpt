    ...
    >
      <Show when={shown()}>
        <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
          <SettingItem icon="i-ri:lock-password-line" label="пароль веб-сайта">
            <input
              type="password"
          ...
          <SettingItem icon="i-carbon:user-online" label="команда системной роли">
            <input
              type="text"
          ...
          <SettingItem icon="i-carbon:data-enrichment" label="Расхождение мышления">
            <input
              type="range"
              min={0}
              max={100}
          ...
          <SettingItem
            ...
            label="Открытие непрерывного диалога удвоит потребление Token"
          >
            <label class="relative inline-flex items-center cursor-pointer ml-1">
              <input
                type="checkbox"
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex">
          <ActionItem
            ...
            label="экспортировать изображение"
          />
          <ActionItem
